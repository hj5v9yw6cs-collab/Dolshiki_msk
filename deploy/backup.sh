...
# В архиве паспорта и договоры клиентов. Права по умолчанию делают его
# доступным на чтение любому пользователю сервера — закрываем и папку,
# и всё, что в неё попадёт.
